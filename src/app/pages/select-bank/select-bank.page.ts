...
export class SelectBankPage implements OnInit {
  ...
  cashEntity: BankEntity = { bankName: 'Efectivo', shortName: 'Efectivo', corporateColorHex: '#1e1e1e', corporateColorHexSecondary: '#FFFFFF', bankType: 'Banco Relevante', code: 'cash' };
